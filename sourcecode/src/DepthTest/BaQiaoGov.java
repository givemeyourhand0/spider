...
public class BaQiaoGov extends BreadthCrawler{  
    
    public BaQiaoGov(String crawlPath, boolean autoParse) {
	...
	public void visit(Page page,CrawlDatums next) {  
		String question_regex="http://www.baqiao.gov.cn/info/news/.*htm"; 
        ...
        {                
            ...
            f.writeFile("E:\\5--政府网站链接\\陕西省\\灞桥区人民政府1.txt",url);
        }  
    }  
  
    public static void main(String[] args) throws Exception{    
    	BaQiaoGov crawler=new BaQiaoGov("BaQiaoGovDepthCrawler",true);  
    	crawler.addSeed("http://www.baqiao.gov.cn/"); 
    	crawler.addRegex("http://www.baqiao.gov.cn/.*");
    	/*不要爬取 jpg|png|gif*/
